...
| Completion | 34.0% weighted; PDX-01, PDX-02, PDX-03, MOB-01, MOB-02, MOB-03, MOB-05, MOB-06, MOB-07, CNT-01, CNT-02, QLT-01 and REL-01 complete. MOB-05 is deliberately the bounded reflection slice; dependency-gated content-bound bookmarks/history/practice tracking are tracked separately as MOB-08 |
...
| GitHub | `0437704` pushed on feature branch `codex/sunnah-everyday-build`; the public GitHub API reports 0 open pull requests for the branch, and creation or update is blocked by unavailable GitHub CLI authentication/session |
| CI | Read-only Quality run [`29683674702`](https://github.com/aafham/Sunnah-Everyday/actions/runs/29683674702) passed contracts, Flutter quality and debug/web smoke for `0437704`; it cannot release or upload |
